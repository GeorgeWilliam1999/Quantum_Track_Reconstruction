...
\caption{(a) The stacked L1--L3 decomposition of the efficiency
lost at the $1\%$ false-rate budget, per operator (fitted response
at its best degree). On base $A$ the entire deficit is L1 —
...
of three channels: \textbf{L1}, spectral twins — the segment's
...
isomorphism; \textbf{L2}, ripple — recovered by another degree of
the same family; \textbf{L3}, threshold overlap — the remainder.
...
with $\mathrm{L2}=\mathrm{L3}=0$: \emph{the deficit is one hundred
...
classical (fixed $\tau$), matched 1BQF (wp99), and the fitted
...
QSVT operator. Under noise, every wp99 curve converges to the false
...
every operator alike; at the flooded wp99 points all five series
...
figure~\ref{fig:budget}, exactly as the L1 budget predicts — and
