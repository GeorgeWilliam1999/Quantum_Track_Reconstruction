...
flops. In a persisted benchmark (repository
\texttt{qsvt\_velo\_paper/benchmarks/}, 2026-07-18) the production
...
segments (systematic motif-twin census: $16$, $15$ and $18$ of
$788$/$783$/$786$ on the three events\footnote{The census
(\texttt{QSVT/Codesign/05\_direct\_twin\_count.py}, 2026-07-18)
counts true segments whose component formation is exactly the false
pair or triple motif, plus isolated stubs; it is
tolerance-independent and replaces an earlier leak-tier heuristic
that read $52$ on the third event through a scale-sensitive
definition (its fit selected a tenfold-larger regulariser). A
by-hand count on the first event previously reached $22$ by also
admitting a handful of contaminated mixed chains under a broader
reading. The robust, definition-free statement is the measured wall
itself: every solver holds $\eff=0.98$ and none holds $\eff=0.99$,
on all three events.}) are
