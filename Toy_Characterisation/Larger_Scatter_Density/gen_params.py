#!/usr/bin/env python3
"""Params for Larger_Scatter_Density (Task 4)."""
...
PHI_GRID = [0.2, 0.1, 0.05, 0.02, 0.01]
SCATTER_GRID = [1e-4, 3e-4]
SIGMA_RES = 0.0; HIT_INEFF = 0.0
            ...
            for T in TRACK_GRID:
                for rep in range(reps_for_T(T)):
                    rows.append(dict(
                        ...
                        phi_max=phi, hit_ineff=HIT_INEFF,
                        ...
                        tag=f"lsd_{gridtag}", outdir=str(cell),
                    ))
