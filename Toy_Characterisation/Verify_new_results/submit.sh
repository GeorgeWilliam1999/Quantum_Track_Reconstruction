...
echo "=========================================="
echo " Verification Sweep Submission"
...
"$CONDA" run -n "$ENV_NAME" python "$BASE_DIR/scripts/gen_params.py" \
...
echo " Aggregate with: $CONDA run -n $ENV_NAME python $BASE_DIR/scripts/aggregate.py --results-dir $RESULTS_DIR"
echo "=========================================="
