#!/usr/bin/env bash
# ── Condor worker wrapper for verification sweeps ────────────────
# Activates the Q_env conda environment and runs the worker script.
#
# Arguments:
...
# Extract job ID from filename (e.g. job_00042.json -> job_00042)
