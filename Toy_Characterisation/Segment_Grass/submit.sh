#!/bin/bash
# ── Segment-Grass sweep: submission orchestrator ─────────────────
#
# Usage:
#   ./submit.sh [--dry-run]
set -e
...
echo "=========================================="
echo " Segment-Grass Sweep Submission"
...
echo " Aggregate with: conda run -n Q_env python $BASE_DIR/scripts/aggregate.py --results-dir $RESULTS_DIR"
echo "=========================================="
