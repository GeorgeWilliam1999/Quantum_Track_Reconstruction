...
\begin{frame}{Add a bifurcation (fork) penalty to the Hamiltonian}
  ...
  \medskip
  \centering\figw{0.88\textwidth}{\PF/fork_matrix.png}\\[2pt]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.49\textwidth}
      \begin{itemize}
        ...
        \item Works \emph{iff} false/true eigenvalues separate; first results: degree-$\sim$30 lifts AUC $0.49/0.64\to\mathbf{0.88}$ [backup].
      \end{itemize}
    \end{column}
  \end{columns}
  \vfill
  \centering\figw{0.96\textwidth}{\QS/polynomial_design.png}
\end{frame}
